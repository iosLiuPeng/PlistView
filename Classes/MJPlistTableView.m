...
#import "MJPlistTableView.h"

#import "UITableViewCell+MJPlistUtils.h"  // cell配置
...
@interface MJPlistTableView () <UITableViewDelegate, UITableViewDataSource>
...
@implementation MJPlistTableView
        ...
        for (NSMutableDictionary *groupDict in _arrDataSource) {
            ...
            for (NSMutableDictionary *cellDict in arrCellDataDict) {
                ...
                if (detailTextKey.length) {
                    [cellDict setObject:detailTextKey forKey:@"detailTextKey"];
                }
            }
        }
    }
